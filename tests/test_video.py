...
def test_landscape_scales_up_roughly_double():
    assert _font_size(1280, 720) == 28   # 16:9 ~ 1.8x the portrait size


def test_mild_landscape_scales_between():
    assert _font_size(1024, 768) == 21   # 4:3 sits between square and 16:9


def test_ultrawide_is_capped():
    assert _font_size(2560, 720) == 32   # cap at 2x base
